...
albu_train_transforms = [
    ...
    dict(type='SafeRotate', p=0.5, border_mode = 0)
...
nx = 1
work_dir = f'./work_dirs/cell/dcn50_{nx}x_hvflip_rot90_small_srot_f0'
evaluation = dict(
    classwise=True, 
    interval=1, 
    metric=['bbox', 'segm'],
...
log_level = 'INFO'
load_from = './weights/cascade_mask_rcnn_r50_fpn_dconv_c3-c5_1x_coco_20200202-42e767a2.pth'
resume_from = None
workflow = [('train', 1)]
