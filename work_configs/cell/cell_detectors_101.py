...
data = dict(
    ...
    test=dict(
            classes=classes,
            type=dataset_type,
            ann_file=data_root + 'train_small/annotations/fold_0.json',
            img_prefix=data_root + 'train_small/images/',
            pipeline=test_pipeline)
)

nx = 1
work_dir = f'./work_dirs/cell/drs101_{nx}x_hvflip_rot90_small_all'
evaluation = dict(
    classwise=True, 
    interval=12, 
    metric=['bbox', 'segm'],
...
log_level = 'INFO'
load_from = './weights/detectors_htc_r101_20e_coco_20210419_203638-348d533b.pth'
resume_from = None
workflow = [('train', 1)]
