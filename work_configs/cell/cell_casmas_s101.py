...
nx = 1
work_dir = f'./work_dirs/cell/casmas_s101_{nx}x_d2_800_f{holdout}'
evaluation = dict(
    classwise=True, 
    interval=12, 
    metric=['bbox', 'segm'],
...
log_level = 'INFO'
load_from = './weights/cascade_mask_rcnn_s101_fpn_syncbn-backbone+head_mstrain_1x_coco_20201005_113243-42607475.pth'
resume_from = None
workflow = [('train', 1)]
