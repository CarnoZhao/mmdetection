...
data = dict(
    ...
    test=dict(
            classes=classes,
            type=dataset_type,
            ann_file=data_root + 'train_small/annotations/train.json',
            img_prefix=data_root + 'train_small/images/',
            pipeline=test_pipeline)
)

nx = 1
work_dir = f'./work_dirs/cell/dcnx101_{nx}x_hvflip_rot90_small_all'
evaluation = dict(
    classwise=True, 
    interval=12, 
    metric=['bbox', 'segm'],
...
log_level = 'INFO'
load_from = './weights/cascade_mask_rcnn_r101_fpn_dconv_c3-c5_1x_coco_20200204-df0c5f10.pth'
resume_from = None
workflow = [('train', 1)]
