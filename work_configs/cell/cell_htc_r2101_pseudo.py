...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=[(1333, 1333), (400, 400)], keep_ratio=True),
...
test_pipeline = [
    ...
    dict(
        ...
        img_scale=[(1333, 1333), (850, 850), (400, 400)],
        flip=True,
...
data = dict(
    ...
    train=[dict(
           ...
           [dict(
            ...
            type="DownSampleCocoDataset",
            downsample=2,
            ann_file=data_root + f'train_semi/annotations/train_semi_with_ann.json',
            img_prefix=data_root + 'train_semi/images/',
...
nx = 1
work_dir = f'./work_dirs/cell/htcr2101_{nx}x_d2_800_f{holdout}_ps'
evaluation = dict(
    classwise=True, 
    interval=12, 
    metric=['bbox', 'segm'],
