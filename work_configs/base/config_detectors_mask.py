...
data = dict(
    ...
    train=dict(
            classes=classes,
            type=dataset_type,
            ann_file=data_root + 'train/jsons/train_fold_0_seg.json',
    ...
    val=dict(
            classes=classes,
            type=dataset_type,
            ann_file=data_root + 'train/jsons/valid_fold_0_seg.json',
            img_prefix=data_root + 'train/images/',
    ...
    test=dict(
            classes=classes,
            type=dataset_type,
            ann_file=data_root + 'train/jsons/no_seg.json',
            img_prefix=data_root + 'train/images/',
            pipeline=test_pipeline),
    # test=dict(
    #         classes=classes,
...
work_dir = './work_dirs/pig/config_detectors_50_gc_mask'
evaluation = dict(
    classwise=True, 
    interval=1, 
    metric=['bbox', 'segm'],
