...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=[(4000, 800), (4000, 1200)], keep_ratio=True),
...
work_dir = './work_dirs/rich/cbs_2x_9bs_gacc_nogc_aav1_rot_co_bj_800_1200'
evaluation = dict(
    classwise=True, 
    interval=12, 
    metric='bbox',
